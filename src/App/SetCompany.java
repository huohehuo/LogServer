 ...
 */
@WebServlet(urlPatterns = "/SetCompany")
public class SetCompany extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(paramter!=null&&!paramter.equals("")){
            try {
                Company company = new Gson().fromJson(paramter,Company.class);
...
//                String str = format.format(curDate);
                ...
                if (ok){
                    response.getWriter().write(CommonJson.getCommonJson(true,"修改成功"));
                }else{
                    response.getWriter().write(CommonJson.getCommonJson(true,"修改失败"));
                }
