 ...
 * 用于更新时间控制表的当前时间
 */
@WebServlet(urlPatterns = "/UploadCompanyRegisterUserDelete")
public class UploadCompanyRegisterUserDelete extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean ok =webDao.deleteCompanyRegister(id,code);
        if (!ok){
            Lg.e("更新成功");
