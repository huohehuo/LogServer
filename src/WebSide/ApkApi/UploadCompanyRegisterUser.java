 ...
 *
 */
@WebServlet(urlPatterns = "/UploadCompanyRegisterUser")
public class UploadCompanyRegisterUser extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean ok =webDao.addCompanyRegister(statisticalBean);
        if (ok){
            Lg.e("更新成功");
