...
<div>
    <br/>
    <h2 style="width: 280px;text-align:center">公司注册码列表-></h2>
</div>
<hr/>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <%
                    ...
                    List listStat = (List) request.getAttribute("company_register");
                ...
                <%
                    for (int i = 0; i < listStat.size(); i++) {
                        Company rs = (Company) listStat.get(i);
                        String changeUrl =BaseData.baseUrl+"/UploadCompanyRegisterUserSet?json="+rs.getAppID()+"&code="+rs.getRegister_code()+"&can="+rs.getCanUse();
                        String deleteUrl =BaseData.baseUrl+"/UploadCompanyRegisterUserDelete?json="+rs.getAppID()+"&code="+rs.getRegister_code();
                %>
                ...
                <tr>
                    ...
                    <td><%=rs.getCreate_time()%></td>
                    <td><a href="<%=changeUrl%>"><%=rs.getCanUse().equals("0")?"不可用":"可用"%></a></td>
                    <td><a href="<%=deleteUrl%>">删除</a></td>
                    <%--<td><a href="../UploadCompanyRegisterUserDelete?json=<%=rs.getAppID()%>&code=<%=rs.getRegister_code()%>">删除</a></td>--%>
